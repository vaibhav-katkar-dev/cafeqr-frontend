      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="border border-slate-100 shadow-2xl rounded-3xl bg-white/90 backdrop-blur-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>Manage orders, menu and tables</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input id="password" type={showPass ? "text" : "password"} placeholder="Your password" {...register("password")} />
              ...
              <div className="flex justify-end">
                <Link href="/auth/forgot-password" className="text-sm text-emerald-600 hover:underline">Forgot password?</Link>
              </div>
              <Button type="submit" className="w-full bg-emerald-500 hover:bg-emerald-600" disabled={loading}>
                {loading ? <><Loader2 className="animate-spin w-4 h-4 mr-2" />Signing in...</> : "Sign In"}
              </Button>
            </form>
            <p className="mt-4 text-center text-sm text-slate-600">
              New here?{" "}
              <Link href="/auth/signup" className="text-emerald-600 font-medium hover:underline">Create a free account</Link>
            </p>
          </CardContent>
        </Card>
      </div>
